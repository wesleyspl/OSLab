...
@section('content_header')
    <h1><i class="fa-solid fa-users "></i> Cadastro Fornecedor</h1>
@stop
    ...
    <div class="col-md-11 ">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            {!! html()->form('post', route('fornecedor.store'))->acceptsFiles()->open() !!}
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        {!! html()->text('nome')->class('form-control')->placeholder('Nome do Fornecedor')->required() !!}
                    </div>
                </div>
            </div>
            <div class="row">
